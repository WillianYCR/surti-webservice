...
public interface ConsultaService {
	...
	UsuarioPerfil insertarUsuarioPerfil(UsuarioPerfil usuarioPerfil) throws CustomException;
	
	UsuarioPerfil modificarUsuario(UsuarioPerfil usuarioPerfil) throws CustomException;
	
	List<UsuarioPerfil> obtenerListaUsuarioPerfil() throws CustomException;
	
	List<UsuarioPerfil> obtenerListaUsuarioPerfilPorIdUsuario(String idUsuario) throws CustomException;
	
	List<UsuarioPerfil> obtenerListaUsuarioPerfilPorIdPerfil(String idPerfil) throws CustomException;

	UsuarioPerfil obtenerUsuarioPerfilPorId(String idUsuarioPerfil) throws CustomException;
	...
	MenuPerfil obtenerMenuPerfilPorId(String idMenuPerfil) throws CustomException;
